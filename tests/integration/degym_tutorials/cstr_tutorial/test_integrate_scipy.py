...
from degym.integrators import ScipyIntegrator, ScipyIntegratorConfig, TimeSpan
...
from degym.integrators import ScipyIntegrator, ScipyIntegratorConfig
...
def test_scipy_integrate() -> None:
    ...
    integrator_config = ScipyIntegratorConfig(action_duration=action_duration)
